...
public class Tracking2CompanyController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<Tracking2> investasiTableView;
    @FXML
    private TableColumn<Tracking2, Double> nominalInvestasiColumn;
    @FXML
    private TableColumn<Tracking2, String> tanggalInvestasiColumn;

    private List<Tracking2> trackingList;
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        List<Tracking2> dataEntries = csvReader.readInvestasiCSV2();
        ObservableList<Tracking2> dataObservableList = FXCollections.observableArrayList(dataEntries);

        TableColumn<Tracking2, String> tanggalColumn = new TableColumn<>("Tanggal");
        tanggalInvestasiColumn.setCellValueFactory(new PropertyValueFactory<>("tanggal"));

        TableColumn<Tracking2, Double> nominalColumn = new TableColumn<>("Nominal");
        ...
        List<XYChart.Data<String, Number>> data = bacaDataDariCSV("LineChart2.csv");
     ...
     public void simpanDataKeCSV(List<XYChart.Data<String, Number>> data, String fileName) {
        try (FileWriter writer = new FileWriter("src/main/java/bettermentfix/LineChart2.csv")) {
    ...
    public List<XYChart.Data<String, Number>> bacaDataDariCSV(String fileName) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/main/java/bettermentfix/LineChart2.csv"))) {
            String line;
    ...
    public void simpanDataChart() {
        ...
        simpanDataKeCSV(data, "LineChart2.csv");
    }
    @FXML
