...
public class Tracking1CompanyController implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<Tracking1> investasiTableView;
    @FXML
    private TableColumn<Tracking1, Double> nominalInvestasiColumn;
    @FXML
    private TableColumn<Tracking1, String> tanggalInvestasiColumn;

    private List<Tracking1> trackingList;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        List<Tracking1> dataEntries = csvReader.readInvestasiCSV1();
        ObservableList<Tracking1> dataObservableList = FXCollections.observableArrayList(dataEntries);

        TableColumn<Tracking1, String> tanggalColumn = new TableColumn<>("Tanggal");
        tanggalInvestasiColumn.setCellValueFactory(new PropertyValueFactory<>("tanggal"));

        TableColumn<Tracking1, Double> nominalColumn = new TableColumn<>("Nominal");
        ...
        List<XYChart.Data<String, Number>> data = bacaDataDariCSV("LineChart.csv");
     ...
     public void simpanDataKeCSV(List<XYChart.Data<String, Number>> data, String fileName) {
        try (FileWriter writer = new FileWriter("src/main/java/bettermentfix/LineChart.csv")) {
    ...
    public List<XYChart.Data<String, Number>> bacaDataDariCSV(String fileName) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/main/java/bettermentfix/LineChart.csv"))) {
            String line;
    ...
    public void simpanDataChart() {
        ...
        simpanDataKeCSV(data, "LineChart.csv");
    }
    @FXML
